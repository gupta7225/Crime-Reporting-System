<html>
 ...
 <%
                ...
                String str="select * from admessages order by date1 asc";
...
<body>
    <h2 align=center>MESSAGES FROM DEPARTMENTS</h2>
 ...
 <div id="section">     
      ...
      <h1>DESCRIPTION :</h1>
      <p1><%=rs.getString(3)%></p1><a href=adminmsg.html align="right">REPLY</a>
